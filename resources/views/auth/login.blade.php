...
<head>
    ...
    <title>{{ config('app.name', 'MyPKPIM') }}</title>
    ...
    <div class="relative bg-gradient-to-bl from-blue-100 via-transparent dark:from-blue-950 dark:via-transparent">
        <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            ...
            <div class="grid items-center md:grid-cols-2 gap-8 lg:gap-12">
                <div>
                    <p
                        ...
                        MyPKPIM : Digitalisasikan pengurusan Keahlian
                    </p>

                    <!-- Title -->
                    <div class="mt-4 md:mb-12 max-w-2xl">
                        <h1 class="mb-4 font-semibold text-gray-800 text-4xl lg:text-5xl dark:text-gray-200">
                            Sistem Pengurusan Keahlian dan Program PKPIM
                        </h1>
                        <p class="text-gray-600 dark:text-gray-400">
                            Menyediakan kemudahan kepada Badan Gabungan Negeri, PKPIM Negeri, PKPIM Kampus sebagai pusat pengurusan Organisasi.
                        </p>
                    </div>
                    <!-- End Title -->
                    ...
                    <blockquote class="hidden md:block relative max-w-sm">
                        ...
                        <div class="relative z-10">
                            <p class="text-xl italic font-extrabold text-gray-800 dark:text-white">
                                Hidup Biar Berjasa !
                            </p>
                        </div>
                ...
                <div>
                    <!-- Form -->
                    <form>
                        <div class="lg:max-w-md lg:mx-auto lg:me-0 ms-auto">
                            <!-- Card -->
                            <div class="p-4 sm:p-7 flex flex-col bg-white rounded-2xl shadow-lg dark:bg-slate-900">
                                <div class="text-center">
                                    <img src="{{asset('PKPIM LOGO.png')}}" alt="" class="w-20 h-auto mx-auto mt-8">
                                    <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Log Masuk</h1>                                   
                                </div>
            ...
            <div
                ...
                <span
                    class="font-semibold bg-clip-text bg-gradient-to-l from-blue-600 to-violet-500 text-transparent dark:from-blue-400 dark:to-violet-400"></span>                Antara PKPIM Negeri, Kampus dan Badan Gabungan Negeri kami.
            </div>
